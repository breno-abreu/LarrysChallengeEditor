...
public:
	...
	void adicionar_entidade(const int mousex, const int mousey, const int tipo, int viewx = 0, int viewy = 0, float proporcao = 3);
	void excluir_entidade(int mousex, int mousey, int viewx, int viewy);
	void limpar_fase();
